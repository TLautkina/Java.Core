...
public class Interface {
    ...
    public void runApplication() throws IOException {
        ...
        while (true) {
            ...
            System.out.println("Choose the weather forecast: 1 - Get the current weather, " +
            ...
            if (result.equals("1") || result.equals("2")) {
                System.out.println("Enter the city name (use '" + Application.getInstance().getLanguage().getTitle() + "' language):");
    ...
    private void setGlobalCity(String city) {
        Application.getInstance().setSelectedCity(city);
    }
