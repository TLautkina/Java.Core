...
import ru.geekbrains.courses.javacore.LautkinaT.Lesson8.HW.Project.JsonProperty.WeatherResponse;
...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    private static final String API_KEY = Application.getInstance().getApiKey();
    private static final Languages LANGUAGE = Application.getInstance().getLanguage();
    ...
    public void getWeather(Periods periods) throws IOException, SQLException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            System.out.println("At the current moment in city " + Application.getInstance().getSelectedCity() +
        ...
        if (periods.equals(Periods.FIVE_DAYS)) {
            ...
            if (objectMapper.readTree(responseBody).size() > 0) {
                ...
                for (WeatherResponse weather: weatherList) {
                    System.out.println("In city " + Application.getInstance().getSelectedCity() + " on date " + weather.getDate().substring(0,10) +
                    ...
                    WeatherData weatherData = new WeatherData(Application.getInstance().getSelectedCity(),
    ...
    public String detectCityKey() throws IOException {
        String selectedCity = Application.getInstance().getSelectedCity();
